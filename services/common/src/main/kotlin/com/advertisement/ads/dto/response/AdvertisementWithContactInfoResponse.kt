...
data class AdvertisementWithContactInfoResponse (
    var id: String?,
    val title: String,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as AdvertisementWithContactInfoResponse
    ...
    override fun toString(): String {
        return "AdvertisementWithContactInfoResponse(id=$id, title='$title', status=$status, description='$description', expirationDate=$expirationDate, city=$city, priceRu=$priceRu, imagesInfo=$imagesInfo, authorId='$authorId', contactInfo=$contactInfo, creationDate=$creationDate, publicationDate=$publicationDate, priorityInfo=$priorityInfo)"
    }
